...
public abstract class PLA_AbsListView extends PLA_AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
    ...
    public PLA_AbsListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int transcriptMode = a.getInt(R.styleable.AbsListView_transcriptMode1, TRANSCRIPT_MODE_DISABLED);
     ...
     *            recycler.
     * 
     * @see com.fourteencells.StudentAssociation.customview.waterfall.PLA_AbsListView.RecycleBin
